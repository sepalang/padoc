    ...
    if(interactive === false){
      ...
      babel.stdout.on('data',(data)=>{
        ...
        if(interactive == true && data.toString().indexOf(">") > -1){
          ...
          const realRunScript = Buffer.from(`const self=require('${realInputPath}'); console.log("global.self << ",self); global.self = self; 'Loading of the module is done. To use exports, check the "self" variable.';\n`, 'utf8')
